...
A small, sleek site for the Cache Valley AI Community — a Logan, Utah meetup for people building with, learning about, or just curious about AI.
...
- `static/dan/index.html` — a hidden personalized landing page (intentionally not linked from anywhere on the public site)
